...
typedef struct Router
{
  ...
  struct Router* (*get)(const char* path, void (*handler)(Request* req, Response* res, void* context), struct Router* self);
  /** Adiciona rota que processa requisições de metodo POST para um determinado recurso */
  struct Router* (*post)(const char* path, void (*handler)(Request* req, Response* res, void* context), struct Router* self);
  /** Adiciona rota que processa requisições de metodo PUT para um determinado recurso */
  struct Router* (*put)(const char* path, void (*handler)(Request* req, Response* res, void* context), struct Router* self);
  /** Adiciona rota que processa requisições de metodo DELETE para um determinado recurso */
  struct Router* (*delete)(const char* path, void (*handler)(Request* req, Response* res, void* context), struct Router* self);
  /** Adiciona um context */
  struct Router* (*setContext)(void* context, struct Router* self);
  /** destroy */
